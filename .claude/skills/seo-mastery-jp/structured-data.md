...
> **注意:** Googleは2026年5月7日をもってFAQリッチリザルトの表示を完全に終了しました（2023年8月以降は著名な政府機関・医療機関サイト限定でした）。このマークアップはGoogle検索でリッチリザルトを生成せず、公式ドキュメントとSearch Consoleのレポートも削除されています。FAQPage自体は有効なschema.orgであり、残置してもペナルティはありません。セマンティックマークアップや他の利用者向けに掲載を継続しています。
